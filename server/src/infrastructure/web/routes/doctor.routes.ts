...
router.get('/all', catchAsync(docotrController.getAllDoctors.bind(docotrController)));
router.get('/:id', authMiddlewareInstance, catchAsync(docotrController.findOne.bind(docotrController)));
router.put('/:id', catchAsync(docotrController.updateDoctor.bind(docotrController)));
